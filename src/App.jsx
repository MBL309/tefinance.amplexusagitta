...
export default function App() {
  return <BrowserRouter><AppShell><Routes><Route path={routes.home} element={<Home />} /><Route path={routes.policy} element={<Policy />} /><Route path={routes.terms} element={<Terms />} /><Route path="*" element={<NotFound />} /></Routes></AppShell></BrowserRouter>
}
